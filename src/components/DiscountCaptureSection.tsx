...
const WHATSAPP_NUMBER = "27761328213"; // 0761328213 in international format
      ...
      <div className="container mx-auto px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          {!code ? (
            ...
            <div className="mx-auto max-w-md border border-primary/40 bg-background p-6 sm:p-8">
...
export default DiscountCaptureSection;